...
import { renameFolders } from "@/lib/actions/workspace.actions";
...
const Folder = ({ name, id, optimistic = false, count = 0 }: Props) => {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "flex hover:bg-neutral-800 cursor-pointer transition-all duration-150 items-center gap-2 justify-between min-w-[250px] py-4 px-4 rounded-lg border-[1px]"
      )}
    >
